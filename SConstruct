...
opts.Add("create_custom_module", "Creates a new empty custom module in the modules/ folder.", "")
...
# Check if creating a custom module
if env_base["create_custom_module"] != "":
    # Create module

    # Convert to snake_case
    custom_module_name = env_base["create_custom_module"].replace(" ", "_")
    custom_module_name = custom_module_name.lower()

    # Make directory
    os.mkdir("modules/" + custom_module_name)

    # Make register_types, config.py, SCsub, and module class
    # register_types Header
    register_types_h = open("modules/" + custom_module_name + "/register_types.h", "w+")
    ...
    # register_types CPP
    register_types_cpp = open("modules/" + custom_module_name + "/register_types.cpp", "w+")
    lines_to_write = [
    ...
    # config.py
    config_py = open("modules/" + custom_module_name + "/config.py", "w+")
    lines_to_write = [
    ...
    # SCsub
    scsub = open("modules/" + custom_module_name + "/SCsub", "w+")
    lines_to_write = [
        "#!/usr/bin/env python\n",
        "Import('env')\n\n",
    ...
    # Create module class
    custom_module_header = open("modules/" + custom_module_name + "/" + custom_module_name + ".h", "w+")
    custom_module_cpp = open("modules/" + custom_module_name + "/" + custom_module_name + ".cpp", "w+")
